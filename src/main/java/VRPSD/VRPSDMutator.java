...
public class VRPSDMutator implements MutationOperator<IntegerSolution> {
    ...
    public VRPSDMutator(IntegerProblem problem, double distributionIndex) {
        this(1.0D / (double)problem.getNumberOfVariables(), distributionIndex);
    }

    public VRPSDMutator(double mutationProbability, double distributionIndex) {
        this(mutationProbability, distributionIndex, new RepairDoubleSolutionAtBounds());
    }

    public VRPSDMutator(double mutationProbability, double distributionIndex, RepairDoubleSolution solutionRepair) {
        this(mutationProbability, distributionIndex, solutionRepair, () -> {
            return JMetalRandom.getInstance().nextDouble();
        });
    }

    public VRPSDMutator(double mutationProbability, double distributionIndex, RepairDoubleSolution solutionRepair, RandomGenerator<Double> randomGenerator) {
