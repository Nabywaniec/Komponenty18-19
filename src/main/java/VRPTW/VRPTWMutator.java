...
public class VRPTWMutator implements MutationOperator<IntegerSolution> {
    ...
    public VRPTWMutator(IntegerProblem problem, double distributionIndex) {
        this(1.0D / (double)problem.getNumberOfVariables(), distributionIndex);
    }

    public VRPTWMutator(double mutationProbability, double distributionIndex) {
        this(mutationProbability, distributionIndex, new RepairDoubleSolutionAtBounds());
    }

    public VRPTWMutator(double mutationProbability, double distributionIndex, RepairDoubleSolution solutionRepair) {
